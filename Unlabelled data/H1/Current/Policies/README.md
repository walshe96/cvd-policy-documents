# Dataset Card for CVD Policy Documents, Unlabelled data, H1, Policies
...
This dataset provides the current policies for bug bounty programmes that use HackerOne.
...
There are 526 policy documents programmes.
...
| Content | String | Programme policy |
...
2. Policies are applicable only for the time of collection.
